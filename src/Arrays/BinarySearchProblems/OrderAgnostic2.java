...
public class OrderAgnostic2 {
    public static void main(String[] args) {
        ...
        System.out.println(orderAgnosticBS(ar,5)); // printing the index of the target value in the array "ar"
        System.out.println(orderAgnosticBS(br,89)); // printing the index of the target value in the array "br"
    }
